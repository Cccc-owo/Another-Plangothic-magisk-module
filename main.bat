...
set fontp1=https://github.com/Fitzgerald-Porthmouth-Koenigsegg/Plangothic/releases/download/V0.8.5727/PlangothicP1-Regular.fallback.ttf
set fontp2=https://github.com/Fitzgerald-Porthmouth-Koenigsegg/Plangothic/releases/download/V0.8.5727/PlangothicP2-Regular.ttf
::==========
