...
set fontp1=https://github.com/Fitzgerald-Porthmouth-Koenigsegg/Plangothic-Project/releases/download/V0.8.5744/PlangothicP1-Regular.fallback.ttf
set fontp2=https://github.com/Fitzgerald-Porthmouth-Koenigsegg/Plangothic-Project/releases/download/V0.8.5744/PlangothicP2-Regular.ttf
::==========
