...
set fontp1=https://github.com/Fitzgerald-Porthmouth-Koenigsegg/Plangothic-Project/releases/download/V1.8.5752/PlangothicP1-Regular.fallback.ttf
set fontp2=https://github.com/Fitzgerald-Porthmouth-Koenigsegg/Plangothic-Project/releases/download/V1.8.5752/PlangothicP2-Regular.ttf
::==========
