...
set fontp1=https://github.com/Fitzgerald-Porthmouth-Koenigsegg/Plangothic/releases/download/V0.7.5720/PlangothicP1-Regular.fallback.ttf
set fontp2=https://github.com/Fitzgerald-Porthmouth-Koenigsegg/Plangothic/releases/download/V0.7.5720/PlangothicP2-Regular.ttf
::==========
